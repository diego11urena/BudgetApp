 ...
 * change (see the useLayoutEffect below) -- so tapping anywhere in the
 * field still behaves the same as tapping at the end.
 *
...
export function CurrencyInput({
  ...
  // Plain useEffect, not useLayoutEffect -- this only ever matters while
  // the field is already focused (mid-interaction), never on the initial
  // SSR/hydration paint, so there's no flash to guard against, and this
